...
def main(filepath):
    ...
    lines = data.split("\n")
    time_lines = np.array(
        [int("".join(filter(str.isdigit, line))) for line in lines if "time=" in line]
    )
    mem_heap_B_lines = np.array(
        [
...
if __name__ == "__main__":
    ...
    parser.add_argument("filepath", type=str, help="Filepath of the massif.out.xxxxx")
